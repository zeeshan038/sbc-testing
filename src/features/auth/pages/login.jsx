...
import { Eye, EyeOff, ArrowRight, CheckCircle2, Cloud, Shield, Zap, ArrowLeft } from 'lucide-react';
...
import { useLoginMutation, useSignInWithGoogleMutation } from '../api/auth';
    ...
    return (
        <div className="min-h-screen w-full flex flex-col md:flex-row font-sans bg-white dark:bg-zinc-950 transition-colors duration-300">
            ...
            <div className="w-full md:w-[45%] lg:w-[40%] flex flex-col justify-center px-6 py-12 md:px-12 lg:px-20 bg-[#f8faff] dark:bg-zinc-950 relative overflow-hidden pt-24 md:pt-32">
                ...
                {/* Background Decoration for Mobile/Left */}
                <div className="absolute top-[-10%] left-[-10%] w-[400px] h-[400px] bg-blue-500/5 rounded-full blur-[100px] pointer-events-none" />

                <motion.div
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.6 }}
                    className="relative z-10 w-full max-w-[400px] mx-auto md:mx-0"
                >
                    {/* Header */}
                    ...
                    <div className="flex items-center gap-3 mb-6 text-gray-100 dark:text-zinc-900">
                        ...
                        <span className="text-[10px] text-gray-400 dark:text-zinc-500 uppercase font-black tracking-widest">or email</span>
                        <div className="flex-1 h-px bg-current" />
                    </div>
                    ...
                    <form className="space-y-4" onSubmit={handleLogin}>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                required
                                className="w-full h-13 px-5 rounded-xl bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 focus:border-[#2b3a8c] dark:focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all text-[15px] dark:text-white placeholder:text-gray-300 dark:placeholder:text-zinc-700 font-medium shadow-sm py-3.5"
                            />
                        </div>

                        <div className="space-y-1.5">
                            <div className="flex justify-between items-center ml-1">
                                <label className="text-[12px] font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wider">Password</label>
                            </div>
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="******************"
                                    required
                                    className="w-full h-13 px-5 pr-13 rounded-xl bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 focus:border-[#2b3a8c] dark:focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all text-[15px] dark:text-white placeholder:text-gray-300 dark:placeholder:text-zinc-700 font-medium shadow-sm py-3.5"
                                />
                        ...
                        <button
                            ...
                            className={`w-full h-14 rounded-xl bg-[#2b3a8c] hover:bg-[#1e2a6a] dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-black text-[15px] transition-all shadow-md flex items-center justify-center gap-2 active:scale-[0.98] mt-2 ${isLoginLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                        >
                            {isLoginLoading ? (
                                <FloatingLoader />
                            ) : 'Submit'}
                    ...
                    <div className="mt-12 flex items-center justify-between text-[13px] font-medium">
                        <p className="text-gray-400">
                            Don't have an account? <Link to="/register" className="text-[#0a0e2e] dark:text-white font-bold hover:underline">Sign up</Link>
                        </p>
                        <a href="#" className="text-gray-400 hover:text-gray-600 dark:hover:text-zinc-300">Terms & Conditions</a>
                    </div>
                </motion.div>
            </div>
            ...
            <div className="hidden md:flex flex-1 bg-[#1a2b6d] relative overflow-hidden items-center justify-center p-12">
                ...
                <div className="relative z-10 w-full h-full max-w-[800px] flex items-center justify-center">
                    ...
                    >
                        ...
                        <h3 className="text-[18px] font-black text-gray-900 dark:text-white mb-1">Transferring</h3>
                    </motion.div>
                    ...
                    >
                        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-1 overflow-hidden shadow-xl border border-white/20">
                            <img
                                src={secureDataImg}
                                alt="Secure Data"
                                className="w-40 h-48 object-cover rounded-[14px]"
                            />
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-1 overflow-hidden shadow-xl border border-white/20">
                            <img
                                src={cloudTransferImg}
                                alt="Cloud Transfer"
                                className="w-48 h-40 object-cover rounded-[14px]"
                            />
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="absolute top-[28%] left-[8%] z-10 opacity-60"
                    >
                        <div className="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-2xl p-3 w-32 aspect-square flex flex-col justify-end shadow-lg">
                            <div className="bg-white/20 p-1.5 rounded-lg w-fit mb-1.5">
                                <Cloud className="text-white w-4 h-4" />
                            </div>
                            <span className="text-white font-bold text-[12px]">Cloud Ready</span>
                        </div>
                    </motion.div>

                    {/* Additional smaller cards to mimic the user's image */}
                    <motion.div
                        animate={{ y: [0, -20, 0] }}
                        transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 1.5 }}
                        className="absolute bottom-[20%] left-[12%] z-20"
                    >
                        <div className="bg-white/10 backdrop-blur-md border border-white/20 p-2 rounded-2xl flex items-center gap-3 pr-6">
                            <div className="w-10 h-10 bg-green-400 rounded-xl flex items-center justify-center">
                                <Zap className="text-white w-5 h-5 fill-white" />
                            </div>
                            <div className="flex flex-col">
                                <span className="text-white font-black text-[14px]">Fast Upload</span>
                                <span className="text-white/50 text-[11px] font-bold uppercase tracking-tight">Ultra latency</span>
                            </div>
                        </div>
                    </motion.div>
                </div>
